...
const SignupPage = () => {
  ...
  const handleGoogleSignup = async () => {
    ...
    try {
      ...
      setLocalError(err.message?.replace('Firebase: ', '') || 'Failed to sign up with Google.');
    } finally {
      setIsSubmitting(false);
    }
  };
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12">
          <div className="w-full max-w-md flex flex-col">
            ...
            <div className="mb-10 text-center lg:text-left right-elem">
              ...
              <p className="font-body-md text-body-md text-on-surface-variant w-full">Get started with FrontPulse today.</p>
            </div>
            ...
            <div className="mt-8 text-center font-body-sm text-body-sm text-on-surface-variant right-elem">
              ...
              <Link href="/login" className="text-primary hover:text-primary-fixed-variant transition-colors font-medium">
                Log in
              </Link>
            </div>
